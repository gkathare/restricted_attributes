    ...
    obj_name=obj.class.name.underscore.downcase
      ...
      begin
        ...
        roles.each do |role_name|
        	if RestrictedRightsManager.rights[role_name] && RestrictedRightsManager.rights[role_name][obj_name]
            permitted_fields |= RestrictedRightsManager.rights[role_name][obj_name][:permit_to] || []
            role_fields |= RestrictedRightsManager.rights[role_name][obj_name][access_type] || []
          end
        end
      rescue
        permitted_fields, role_fields = [], []
